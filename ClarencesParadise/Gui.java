...
class Gui extends JFrame implements ActionListener, KeyListener {
    ...
    public Gui() {
        ...
        display.setPreferredSize(new Dimension(980, 660)); //dimensions of GIFs plus 20 on each side for the borders
        //display.setMaximumSize(new Dimension(980, 660)); //Setting a maximum is maybe not necessary.
        display.setMinimumSize(new Dimension(980, 660)); //Setting a minimum keeps it from disappearing when resized, also keeps the dims of gifs from affecting the JPanel.
